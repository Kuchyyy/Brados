...
export function DottedGlowBackground({
  ...
  // 🔹 Dodajemy IntersectionObserver do kontroli widoczności
  useEffect(() => {
  ...
  // 🔹 Aktualizacja kolorów (tak jak w Twojej wersji)
  useEffect(() => {
  ...
  // 🔹 Animacja tylko, gdy komponent jest widoczny
  useEffect(() => {
    const el = canvasRef.current;
    const container = containerRef.current;
    if (!el || !container || !isVisible) return;
  ...
  }, [gap, radius, resolvedColor, resolvedGlowColor, opacity, backgroundOpacity, speedMin, speedMax, speedScale, isVisible]);
